...
class Login:
    def __init__(self,root): 
        ...
        # buttons
        b1=Button(frame,relief=RIDGE,text="LOG IN",command=self.login,borderwidth=2,font=("times new roman",18,"bold"),bg="red",fg="white",cursor="hand2",activebackground="white")
    ...
    def forgot_password_window(self):
        if self.txt_user_email.get()=="":
            ...
            if row==None:
                ...
                # buttons
                b2=Button(self.root_window,relief=RIDGE,text="RESET",command=self.login,borderwidth=2,font=("times new roman",18,"bold"),bg="red",fg="white",cursor="hand2",activebackground="white")
